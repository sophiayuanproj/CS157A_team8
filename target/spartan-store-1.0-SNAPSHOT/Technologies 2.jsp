...
<%
    ...
    try {
        ...
        ResultSet rs = stmt.executeQuery("SELECT Technologies.ItemName, ItemDescription, Image, Price, " +
                "Technologies.ItemID, Items.ItemType " +
                "FROM Technologies JOIN Items USING (ItemID) WHERE ItemType=" +  "\"" + "Technologies" + "\";");
