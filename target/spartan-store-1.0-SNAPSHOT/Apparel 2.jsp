...
<%
    ...
    try {
        ...
        ResultSet rs = stmt.executeQuery("SELECT Apparel.ItemName," + "Size," + " Color, ItemDescription, Image, " +
                "Price, Apparel.ItemID, Items.ItemType " +
                "FROM Apparel JOIN Items USING (ItemID) WHERE ItemType=" +  "\"" + "Apparel" + "\";");

        out.println("<table border=\"1\" align=\"center\">\n" +
                "        <tr>\n" +
                "            <th width=\"175\">Image</th>\n" +
                "            <th width=\"175\">Item Name</th>\n" +
                "            <th width=\"175\">Size</th>\n" +
                "            <th width=\"175\">Color</th>\n" +
